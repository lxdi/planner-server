...
export class TaskModal extends React.Component {
  constructor(props){
    ...
    registerEvent('task-modal', 'open', (stateSetter, subject, task, isViewOnly)=>this.setState(getState(subject, task, isViewOnly)))
...
const getState = function(subject, task, isViewOnly){
  var state = null
