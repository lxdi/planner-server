...
public class HquartersDelegateTests extends AbstractTestsWithTargets {
    ...
    public void getPrevTest(){
        ...
        assertTrue(DateUtils.fromDate(hQuartersLazy2017.get(0).getStartWeek().getStartDay()).equals("2017-06-19"));
    ...
    public void getNextTest(){
        quarterGenerator.generateYear(2018);
        List<HQuarter> hQuarters2018 = hQuarterDAO.getHQuartersInYear(2018);
        HQuarter lastHquarter = hQuarters2018.get(7);
        assertTrue(DateUtils.fromDate(lastHquarter.getStartWeek().getStartDay()).equals("2018-10-22"));
