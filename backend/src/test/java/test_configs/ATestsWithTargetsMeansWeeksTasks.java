...
//    protected String task3title = "Task 3 title without mean";
//    protected String task4title = "Task 4 title without week and mean";
//
//    @Before
//    public void init(){
//        super.init();
...
//
//        Task task3 = new Task();
//        task3.setTitle(task3title);
//        task3.setWeek(weekDAO.weekByStartDate(30, 7, 2018));
//        tasksDAO.saveOrUpdate(task3);
//
//        Task task4 = new Task();
//        task4.setTitle(task4title);
//        tasksDAO.saveOrUpdate(task4);
//
//        assertTrue(task1.getId()>0);
//        assertTrue(task2.getId()>0);
//        assertTrue(task3.getId()>0);
//        assertTrue(task4.getId()>0);
//
//    }
