...
public class TaskMapperDaoTests extends AbstractTestsWithTargets {
    ...
    public void getFinishDateTest(){
        ...
        TaskMapper taskMapper = new TaskMapper();
        taskMapper.setTask(task);
        taskMapper.setFactDay(new Day(DateUtils.currentDate()));
        taskMappersDAO.saveOrUpdate(taskMapper);
    ...
    public void byWeekAndDayTest(){
        //TODO fix test byWeekAndDayTest
...
//        assertTrue(taskMappers.get(0).getId() == taskMapper.getId());
    ...
    public void taskMappersOfHqAndBeforeTest(){
        ...
        TaskMapper taskMapperBefore1 = testCreators.createTaskMapper(null,
                dayDao.byWeekAndDayOfWeek(weeks.get(0), slotPosition2.getDayOfWeek()));
        TaskMapper taskMapperBefore2 = testCreators.createTaskMapper(null,
                dayDao.byWeekAndDayOfWeek(weeks.get(0), slotPosition3.getDayOfWeek()));
        TaskMapper taskMapperBefore3 = testCreators.createTaskMapper(null,
                dayDao.byWeekAndDayOfWeek(weeks.get(1), slotPosition1.getDayOfWeek()));
        TaskMapper taskMapperAfter1 = testCreators.createTaskMapper(null,
                dayDao.byWeekAndDayOfWeek(weeks.get(1), slotPosition2.getDayOfWeek()));
        TaskMapper taskMapperAfter2 = testCreators.createTaskMapper(null,
                dayDao.byWeekAndDayOfWeek(weeks.get(1), slotPosition3.getDayOfWeek()));
        TaskMapper taskMapperAfter3 = testCreators.createTaskMapper(null,
                dayDao.byWeekAndDayOfWeek(weeks.get(2), slotPosition1.getDayOfWeek()));
    ...
    public void taskMappersOfHqAndBeforeIfEndOfWeekTest(){
        //TODO fix taskMappersOfHqAndBeforeIfEndOfWeekTest
        throw new UnsupportedOperationException();
//        quarterGenerator.generateYear(2019);
//        HQuarter hQuarter = ihQuarterDAO.getHQuartersInYear(2019).get(3);
//        List<Week> weeks = weekDAO.weeksOfHquarter(hQuarter);
