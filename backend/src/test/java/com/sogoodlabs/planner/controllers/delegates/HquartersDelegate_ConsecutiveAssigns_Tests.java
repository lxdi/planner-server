...
public class HquartersDelegate_ConsecutiveAssigns_Tests extends ATestsWithTargetsMeansQuartalsGenerated {
    ...
    public void createTaskMappersTest(){
        ...
        assertTrue(slotDAO.getOne(slot1.getId()).getId()==layerDAO.getLayerAtPriority(mean, 1).getId());

        List<Week> weeks = weekDAO.weeksOfHquarter(hQuarter1);

        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 1")), weeks.get(0), slotPosition11);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2")), weeks.get(0), slotPosition12);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 3")), weeks.get(0), slotPosition13);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 4")), weeks.get(1), slotPosition11);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 5")), weeks.get(1), slotPosition12);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 6")), weeks.get(1), slotPosition13);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 7")), weeks.get(2), slotPosition11);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 8")), weeks.get(2), slotPosition12);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 9")), weeks.get(2), slotPosition13);
    ...
    public void createTaskMappersTwiceTest(){
        ...
        assertTrue(slotDAO.getOne(slot2.getId()).getId()==layerDAO.getLayerAtPriority(mean, 2).getId());
        ...
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-1")), weeksHq2.get(0), slotPosition21);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-2")), weeksHq2.get(0), slotPosition22);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-3")), weeksHq2.get(0), slotPosition23);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-4")), weeksHq2.get(1), slotPosition21);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-5")), weeksHq2.get(1), slotPosition22);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-6")), weeksHq2.get(1), slotPosition23);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-7")), weeksHq2.get(2), slotPosition21);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-8")), weeksHq2.get(2), slotPosition22);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-9")), weeksHq2.get(2), slotPosition23);
