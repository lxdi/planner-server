...
//        layerDAO.saveOrUpdate(layer3);
    ...
    public void unassignMiddleSlotTest(){
        ...
        assertTrue(slotDAO.getOne(slot2.getId()).getLayer().getId()==layerDAO.getLayerAtPriority(mean, 2).getId());

        assertTrue(slotDAO.getOne(slot3.getId()).getMean().getId()==mean.getId());
        assertTrue(slotDAO.getOne(slot3.getId()).getLayer()==null);
        ...
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-1")), weeksHq2.get(0), slotPosition31);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-2")), weeksHq2.get(0), slotPosition32);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-3")), weeksHq2.get(0), slotPosition33);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-4")), weeksHq2.get(1), slotPosition31);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-5")), weeksHq2.get(1), slotPosition32);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-6")), weeksHq2.get(1), slotPosition33);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-7")), weeksHq2.get(2), slotPosition31);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-8")), weeksHq2.get(2), slotPosition32);
        checkTaskMapper(taskMappersDAO.taskMapperForTask(tasksDAO.findByTitle("task 2-9")), weeksHq2.get(2), slotPosition33);
